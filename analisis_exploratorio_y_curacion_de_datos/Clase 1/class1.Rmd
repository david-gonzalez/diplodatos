...
E R es posible simular facilmente esta situacion con la funcion **sample**.
...
Por ejemplo si $x$ esta dada por una densidad de probabilidad $f$ y una CDF $F$ , entonces vale la relacion: $F(x)=\int_{-\infty}^{x} f(t) \delta t$ y si elegmimos $U = F (X)$, con $U$ una 
